...
const MobileNavbar = ({ open, setOpen }) => {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetContent
        side="left"
        className="bg-transparent backdrop-filter backdrop-blur-lg bg-opacity-30 border-b border-neutral-900 text-white"
      >
        <div className="flex flex-col space-y-3 gap-y-5">
          <div className="flex justify-center items-center gap-2 lg:text-2xl bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 tracking-wide">
            <img
              className="w-[50px]"
          ...
          <div className="text-center w-full">
            <NavLink className="w-full text-base hover:text-white/90" to="/">
              Home
            </NavLink>
            <Separator className="mt-1 bg-white/20 h-[1px]" />
          </div>
          <div className="text-center w-full">
            <NavLink className="text-base hover:text-white/90" to="/profiles">
              Discover
            </NavLink>
            <Separator className="mt-1 bg-white/20 h-[1px]" />
          </div>
